...
import { faFileExport, faShareFromSquare, faPencil, faSave, faCancel, faTrashCan, faClipboard, faStar, faQ, faFileCsv, faImages, faBolt } from "@fortawesome/free-solid-svg-icons";
